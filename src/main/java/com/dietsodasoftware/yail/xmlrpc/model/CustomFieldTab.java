 ...
 * Time: 12:11 AM
 */
@TableName(table = "DataFormTab")
public class CustomFieldTab extends Model {


    public CustomFieldTab(Map<String, Object> model) {
        super(model);
    }
    ...
    public enum Field implements NamedField {
        ...
        FormId(Integer.class, Access.Read),
        TabName(String.class, Access.Read)
        ;
    ...
    public static Builder<CustomFieldTab> builder(){
        return new Builder<CustomFieldTab>(CustomFieldTab.class);
    }
}
